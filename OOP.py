...
# Студенты
student_1 = Student('Игорь', 'Епифанцев', 'Муж')
student_1.courses_in_progress += ['Python']
student_1.finished_courses += ["Введение в програмирование"]
student_2 = Student('Анастасия', 'Дудкина', 'Жен')
student_2.courses_in_progress += ['Python']
student_2.finished_courses += ["Введение в програмирование"]

# Лекторы
lecturer_1 = Lecturer('Кирилл', 'Иванов')
lecturer_1.courses_attached += ['Python']
lecturer_2 = Lecturer('Катерина', 'Щукина')
lecturer_2.courses_attached += ['Python']

# Проверяющие
reviewer_1 = Reviewer('Андрей', 'Потапов')
reviewer_1.courses_attached += ['Python']
reviewer_2 = Reviewer('Ксения', 'Меньшкова')
...
# Оценки лекторам
student_1.rate(lecturer_1, 'Python', 8)
student_1.rate(lecturer_1, 'Python', 8)
